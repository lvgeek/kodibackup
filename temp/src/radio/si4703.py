class si4703:
	...
	print "Starting Radio Module..."
        ...
        GPIO.output(4 ,GPIO.LOW) ## But I ripped this code off somewhere else, so I'm not gonna bash it. Great work to the OP
        sleep(.1)
        ...
        si4703.SYS_CONFIG_2.VOLUME = 0
	si4703.SYS_CONFIG_2.SPACE = 1
        si4703.write_registry(self)
        sleep(0.1)
        ...
        si4703.write_registry(self)
	print "Radio Module successfully initialized"
    ...
    def volume (self, volume):
        ...
        si4703.SYS_CONFIG_2.VOLUME = int(volume) ## Finally, let's save all that work
	...
	print"\t", "RSSI", si4703.STATUS_RSSI.RSSI
